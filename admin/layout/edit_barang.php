        ...
        <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content" style="display: block;">
                    ...
                    ?>
                    <form action="../logic_action/proses_edit_barang.php" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9">
                                <textarea name="Data3" id="" cols="30" rows="10" class="form-control"><?php echo $data['keterangan']; ?></textarea>
                            </div>
                        </div>
